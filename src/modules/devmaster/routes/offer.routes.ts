...
import { 
  ...
  filterOffers,
  filterOffersPaginated} from '../controller/offer.controller';

const router = Router();

// Rutas de filtrado
router.get('/filter', filterOffersPaginated);                                // GET /offers/filter?range=A-C&city=La Paz&category=Fontanero
...
// Rutas generales
router.get('/offers', getOffers);                                      // GET /offers
